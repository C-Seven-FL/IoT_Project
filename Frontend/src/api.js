...
export const api = {
  ...
  userPendingApprovals: () => request('GET', '/user/pending-approvals'),
  userApproveBuilding: (userId) => request('POST', `/user/${userId}/approve-building`),
  userRejectBuilding: (userId) => request('POST', `/user/${userId}/reject-building`),
